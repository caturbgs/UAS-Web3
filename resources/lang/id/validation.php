    ...
    */
    ...
    'custom' => [
        'nis' => [
            ...
            'string' => 'Kolom NIS harus berupa string',
            'size' => 'Kolom NIS harus :size angka',
            'unique' => 'NIS sudah terpakai',
            'numeric' => 'NIS harus diisi berupa angka',
        ],
        'nama_siswa' => [
        ...
        'jk' => [
            ...
            'in' => 'Kolom Jenis Kelamin harus diisi Laki-laki atau Perempuan',
        ],
        'alamat' => [
        ...
        'no_telp' => [
            ...
            'numeric' => 'Nomor Telepon harus diisi berupa angka',
            'digits_between' => 'Nomor Telepon harus terdiri antara :min atau :max digit angka',
        ],
        'eskul' => [
        ...
        'foto' => [
            ...
            'max' => 'Kolom Foto tidak boleh lebih dari 500 KB.alert',
            'mimes' => 'Kolom Foto hanya boleh diisi file *.jpg, *.jpeg, *.png.',
            'dimensions' => 'Foto minimal harus berukuran 354x472 pixel.',
        ],
        'nip' => [
            ...
            'numeric' => 'NIP harus diisi berupa angka',
        ],
        'nama_guru' => [
            'required' => 'Kolom Nama Guru harus diisi',
            'string' => 'Kolom Nama Guru harus berupa huruf',
